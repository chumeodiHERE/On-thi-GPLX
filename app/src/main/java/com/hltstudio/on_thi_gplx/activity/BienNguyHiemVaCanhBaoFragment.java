...
public class BienNguyHiemVaCanhBaoFragment extends Fragment {
    ...
    public BienNguyHiemVaCanhBaoFragment() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_bien_nguy_hiem_va_canh_bao, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.listBienNguyHiem);
        list = helper.getRSWithRSID(4);
